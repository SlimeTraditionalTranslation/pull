...
exports.getPRBody = (repoPath, prNumber) =>
  (prNumber
    ? `查看 [提交](/${repoPath}/pull/${prNumber}/commits) 和 [變化](/${repoPath}/pull/${prNumber}/files) 來獲得更多訊息.\n\n-----\nCreated by [<img src="https://prod.download/pull-18h-svg" valign="bottom"/> **pull[bot]**](https://github.com/wei/pull) | Using on [SlimeTraditionalTranslation](https://github.com/SlimeTraditionalTranslation)`
    : '查看PR來獲取更多自動合併資訊! \n\n-----\nCreated by [<img src="https://prod.download/pull-18h-svg" valign="bottom"/> **pull[bot]**](https://github.com/wei/pull) | Using on [SlimeTraditionalTranslation](https://github.com/SlimeTraditionalTranslation)') +
